;; This is a pox-2 test implementation for sbtc-mini
;; The following are originally private VM functions that are now public for testing purposes
;; "handle-unlock," ""
...
(define-constant test-pr-con u1)
